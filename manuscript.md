...
header-includes: |
  ...
  <meta name="dc.modified" content="2024-11-17T04:23:20+00:00" />
  <meta property="article:modified_time" content="2024-11-17T04:23:20+00:00" />
  ...
  <link rel="alternate" type="text/html" href="https://uiceds.github.io/project-team-wres/v/534fe1ff95776e18f38ccc221c8aa213f0144e78/" />
  <meta name="manubot_html_url_versioned" content="https://uiceds.github.io/project-team-wres/v/534fe1ff95776e18f38ccc221c8aa213f0144e78/" />
  <meta name="manubot_pdf_url_versioned" content="https://uiceds.github.io/project-team-wres/v/534fe1ff95776e18f38ccc221c8aa213f0144e78/manuscript.pdf" />
  <meta property="og:type" content="article" />
...
<small><em>
This manuscript
([permalink](https://uiceds.github.io/project-team-wres/v/534fe1ff95776e18f38ccc221c8aa213f0144e78/))
was automatically generated
from [uiceds/project-team-wres@534fe1f](https://github.com/uiceds/project-team-wres/tree/534fe1ff95776e18f38ccc221c8aa213f0144e78)
on November 17, 2024.
</em></small>
...
![Fig 4: Time series plot based on basic regression](./images/RegressionTimePlot.png){width=80%}

![Fig 5: Scatter plot based on basic regression](./images/RegressionScatterPlot.png){width=80%}

![Fig 6: Time series plot based on basic regression](./images/RegressionTimePlot2021.png){width=80%}

![Fig 7: Scatter plot based on basic regression](./images/RegressionScatterPlot2021.png){width=80%}
...
![Fig 8: Time series plot based on normalized regression](./images/NormalizedRegressionTimePlot.png){width=80%}

![Fig 9: Scatter plot based on normalized regression](./images/NormalizedRegressionScatterPlot.png){width=80%}

![Fig 10: Time series plot based on normalized regression](./images/NormalizedRegressionTimePlot2021.png){width=80%}

![Fig 11: Scatter plot based on normalized regression](./images/NormalizedRegressionScatterPlot2021.png){width=80%}
...
![Fig 12: Time series plot based on PCA regression](./images/PCARegressionTimePlot.png){width=80%}

![Fig 13: Scatter plot based on PCA regression](./images/PCARegressionScatterPlot.png){width=80%}

![Fig 14: Time series plot based on PCA regression](./images/PCARegressionTimePlot2021.png){width=80%}

![Fig 15: Scatter plot based on PCA regression](./images/PCARegressionScatterPlot2021.png){width=80%}
...
![Fig 18: Time series plot based on PCA regression](./images/PCARegressionTimePlotCombine2021.png){width=80%}

![Fig 19: Scatter plot based on PCA regression](./images/PCARegressionScatterPlotCombine2021.png){width=80%}
...
![Fig 20: Time series plot based on single layer neural network](./images/SingleNNRegressionTimePlot.png){width=80%}

![Fig 21: Scatter plot based on single layer neural network](./images/SingleNNRegressionScatterPlot.png){width=80%}

![Fig 22: Time series plot based on single layer neural network](./images/SingleNNRegressionTimePlot2021.png){width=80%}

![Fig 23: Scatter plot based on single layer neural network](./images/SingleNNRegressionScatterPlot2021.png){width=80%}
...
![Fig 24: Time series plot based on double layer neural network](./images/DoubleNNRegressionTimePlot.png){width=80%}

![Fig 25: Scatter plot based on double layer neural network](./images/DoubleNNRegressionScatterPlot.png){width=80%}

![Fig 24: Time series plot based on double layer neural network](./images/DoubleNNRegressionTimePlot2021.png){width=80%}

![Fig 25: Scatter plot based on double layer neural network](./images/DoubleNNRegressionScatterPlot2021.png){width=80%}
...
![Fig 26: Time series plot based on quadra layer neural network](./images/QuadraNNRegressionTimePlot.png){width=80%}

![Fig 27: Scatter plot based on quadra layer neural network](./images/QuadraNNRegressionScatterPlot.png){width=80%}

![Fig 28: Time series plot based on quadra layer neural network](./images/QuadraNNRegressionTimePlot2021.png){width=80%}

![Fig 29: Scatter plot based on quadra layer neural network](./images/QuadraNNRegressionScatterPlot2021.png){width=80%}
...
![Fig 26: Time series plot based on CNN neural network](./images/CNN_RegressionTimePlot.png){width=80%}

![Fig 27: Scatter plot based on CNN neural network](./images/CNNRegressionScatterPlot.png){width=80%}

![Fig 26: Time series plot based on CNN neural network](./images/CNN_RegressionTimePlot2021.png){width=80%}

![Fig 27: Scatter plot based on CNN neural network](./images/CNNRegressionScatterPlot2021.png){width=80%}
